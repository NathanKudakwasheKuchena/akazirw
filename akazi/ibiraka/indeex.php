	...
	<div class="sixteen columns">
		...
		<nav id="navigation" class="menu">
			<ul id="responsive">
				...
				<li><a id="current" href="indeex.php">Home</a>
				</li>
				...
				<li><a href="dashboard-add-job.php">Add Skill </a>
				</li>
		...
		<div class="sixteen columns">
			...
			<center><h2 style="color: #FFFFFF;">Get visible and get paid for your skills</h2></center>
						...
						<ul class="float-right">
							...
							<a href="dashboard-add-job.php"> <input id='firstsearch' type="button" style= 'color:white' readonly class="ico-01" value="Add A Skill/Garagaza Ubumenyi"  name='title' placeholder="Find Skill" />
							</a></li>
						</ul> <br>  <br>
				...
				<!-- <div class="browse-jobs">
					Browse Skills offers by  <a href="#">location</a>
				</div> -->
