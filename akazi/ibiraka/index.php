...
<meta charset="utf-8">
<title>Akazi</title>
<?php error_reporting(0); include "vacancy/header.php"?>
...
<body>
<?php include'vacancy/dbcon.php';  //include "vacancy/session.php"?>
<div id="wrapper">
...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
		<h1><a href=""><img  src="images/logo2.png" alt="Akazi" /></a></h1>
		</div>
		...
		<nav id="navigation" class="menu">
			...
			<ul class="float-right">
				<li><a href="vacancy/register.php"><i class="fa fa-user"></i> Sign Up</a></li>
...
<div id="banner" class="with-transparent-header parallax background" style="background-image: url(images/banner-home-02.jpg)" data-img-width="2000" data-img-height="1330" data-diff="300">
	<div class="container">
		<div class="sixteen columns">
			...
			<center><h2 style="color: #FFFFFF;">Get visible and get paid for your skills</h2></center>
			
			<center><p><font size="6" color="#FFFFFF">Igaragaze wishyurirwe ubwenge bwawe</font></p></center>

						<ul class="float-right">
							<li>
							 
							<a href="browse-job.php"> <input id='firstsearch' type="button" style= 'color:white' readonly class="ico-01" value="Find Skill/Shaka Umukozi"  name='title' placeholder="Find Skill/Shaka Umukozi " />
							</a>
							
							<a href="vacancy/register.php"> <input id='firstsearch' type="button" style= 'color:white' readonly class="ico-01" value="Add A Skill/Garagaza Ubumenyi"  name='title' placeholder="Find Skill" />
							</a></li>
						</ul> <br>  <br>
					
				 <br>
				 <form class='form-sample' method='POST' action='searchskil.php'>
						<input type="text" class="ico-01" name='title' v-model="title"  placeholder="job title/akazi" value=""/>
						<input type="text" class="ico-02" name='location' v-model="location" placeholder="city, province or region/Intara " value=""/>
					<button  style='background-color:green' class="button centered" type='submit' v-on:click="search()"
...
<ul >
	...
	<script type="text/javascript">
		...
		<?php
	if(isset($_POST['chat'])) {
		echo "<script>alert('Register with Akazi')</script>";
		echo "<script>window.open('vacancy/register.php','_self')</script>";
	}
...
<div id="footer">
	...
	<div class="container">
		...
		<div class="seven columns">
			<h4>About</h4>
			<p>An online platform that connects clients with service providers in the informal sector.</p>
