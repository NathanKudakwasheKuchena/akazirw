...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
			<h1><a href="indeex.php"><img src="images/logo.png" alt="Ibiraka" /></a></h1>
		</div>
			...
			<ul data-submenu-title="Management">
				...
				<li><a>For Candidates</a>
					<ul>
						...
						<li><a href="dashboard-manage-applications.php">Manage Applications <span class="nav-tag"><?php echo $applicationscount; ?></span></a></li>
	...
	<div class="dashboard-content">
		...
		<?php
			...
			<form class="form-sample" method="POST" action="">
				...
				<button type="submit" class="button margin-top-15" name="savechanges" id="editchanges">Save Changes</button><br>
			...
			<?php
				...
				echo "<script>alert('Resume Edited')</script>";
