...
<div class="container">
	<div class="sixteen columns">
		...
		<!-- Logo -->
		<div id="logo">
		<h1><a href="indeex.php"><img  src="images/logo2.png" alt="Ibiraka" /></a></h1>
		</div>
	...
	<div class="container">
		<div class="sixteen columns">
			...
			<div class="search-container">
				...
				<form class='form-sample' method='POST' action='getskillsbysearch.php'>
						<input type="text" class="ico-01" name='title'  placeholder="job title" value=""/>
                    ...
                    var indeex = new Vue({
                        ...
                        methods: {
                            ...
                            getAllLogSheets() {
                                ...
                                axios
                                        .get("http://localhost/Ibiraka/getallskills.php")
                                        .then(res => {
							...
							like(JOBID){
								...
								$.ajax({
								  type: "POST",
								  url: "http://localhost/Ibiraka/postlike.php",
								  dataType: "json",
								  data: {JOBID: JOBID},
		...
		<div class="footer-bottom">
			<div class="sixteen columns">
				...
				<ul class="social-icons">
					...
					<li><a class="twitter" href="#"></i></a></li>
